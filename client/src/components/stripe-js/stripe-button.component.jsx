// note this uses a library from the react tutorial. It uses checkout component which might be deprecated???
...
const StripeCheckoutButton = ({ price }) => {
  const priceForStripe = price * 100; // because stripe wants to see this in cents
  // bf key
